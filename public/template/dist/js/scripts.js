...
var btn     = document.getElementById('sliderBtn'),
    ...
    if (btn && sideBar) {
        btn.addEventListener('click' , function(){    
            ...
            if (sideBar.classList.contains('-ml-64')) {
                sideBar.classList.replace('-ml-64' , 'ml-0');
            }
        });
    }
    ...
    if (sideBarHideBtn && sideBar) {
        sideBarHideBtn.addEventListener('click' , function(){            
            var isMobileOpen = sideBar.classList.contains('md:ml-0');
            var isDesktopOpen = sideBar.classList.contains('ml-0');
            ...
            if (isDesktopOpen) {
                sideBar.classList.replace('ml-0' , '-ml-64');
            }
        });
    }
...
var options = function(type, height, numbers , color){
  ...
  if (typeof ApexCharts !== 'undefined' && analytics_1 != null && typeof(analytics_1) != 'undefined' && analytics_1.length > 0) {
...
if (typeof ApexCharts !== 'undefined' && sealsOverview) {
...
var options = {     
  ...
  if (typeof ApexCharts !== 'undefined' && SummaryChart != null && typeof(SummaryChart) != 'undefined') {
